...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .list-group-food .list-group-item .veg{
            color: #ff1d8e;
            font-size: 20px;
            margin-left: 10px;
            padding-top: 7px;
            ...
            .list-group-food .list-group-item .veg-prc{
            color: black;
            font-size: 18px;
            margin-left: 345px;
            }

            .list-group-food .list-group-item .non-veg{
            color: #ff1d8e;
            font-size: 20px;
            margin-left: 10px;
            padding-top: 7px;
            ...
            .list-group-food .list-group-item .non-veg-prc{
            color: black;
            font-size: 18px;
            margin-left: 303px;
            }
            ...
            .btn-booking-food:hover, .btn-booking-food:focus{
            color: white;
            background-color: #008631;
            }
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-food" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="booking.php" class="btn-booking-food" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
        ...
        <ul class="list-group-food">
            <li class="list-group-item">
                ...
                <label for="veg-prc" class="veg-prc">
                    Veg Price
                </label>
            </li>
            <li class="list-group-item">
                ...
                <label for="non-veg-prc" class="non-veg-prc">
                    Non-Veg Price
                </label>
            </li>
        </ul>
