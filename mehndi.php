...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .list-group-mehndi .list-group-item .bridal-prc{
            color: #ff1d8e;
            font-size: 20px;
            margin-left: 10px;
            padding-top: 7px;
            ...
            .list-group-mehndi .list-group-item .bridal{
            color: black;
            font-size: 18px;
            margin-left: 300px;
            }
            ...
            .btn-booking-mehndi:hover, .btn-booking-mehndi:focus{
            color: white;
            background-color: #008631;
            }
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-mehndi" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="booking.php" class="btn-booking-mehndi" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
        ...
        <ul class="list-group-mehndi">
            <li class="list-group-item">
                <label for="bridal-prc" class="bridal-prc">
                    ₹
                    <?php 
