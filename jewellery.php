<?php
    ...
    include("config.php");
    $id=$_GET['id'];
    $query="SELECT * FROM `jewellery` WHERE `id` = '$id'";
...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .list-group-jewellery .list-group-item .starting-prc{
            color: #ff1d8e;
            font-size: 20px;
            margin-left: 10px;
            padding-top: 7px;
            ...
            .list-group-jewellery .list-group-item .starting{
            color: black;
            font-size: 18px;
            margin-left: 300px;
            }
            ...
            .navbar-brand-jewellery:hover{
                color: white;
            }

            .btn-booking-jewellery{
            color: #ff1d8e;
            background-color: white;
            text-decoration: none;
            font-size: 18px;
            ...
            .btn-booking-jewellery:hover, .btn-booking-jewellery:focus{
            color: white;
            background-color: #008631;
            }
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-jewellery" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="booking.php" class="btn-booking-jewellery" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
        ...
        <ul class="list-group-jewellery">
            <li class="list-group-item">
                <label for="starting-prc" class="starting-prc">
                    ₹
                    <?php 
