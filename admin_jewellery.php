...
<html lang="en">
    ...
    <body>
        <div class="admin-jewellery" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Jewellery List
                <a href="add_jewellery.php" class="btn-add-jewellery-admin">
                    Add Jewellery
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <br>
                                <a href="edit_jewellery.php?id=<?php echo $data['id']; ?>" class="btn-edit-jewellery" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_jewellery.php?id=<?php echo $data['id']; ?>" class="btn-delete-jewellery" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
