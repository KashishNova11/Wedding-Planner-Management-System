...
.btn-add-decorators-admin:hover, .btn-add-decorators-admin:focus{
  color: white;
...
.btn-back-admin:hover, .btn-back-admin:focus{
  color: white;
  background-color: grey;
}

.card-body .btn-edit-decorators{
  color: white;
...
.card-body .btn-edit-decorators:hover, .card-body .btn-edit-decorators:focus{
  color: #008631;
  background-color: white;
  border-radius: 5px;
  border: 1px solid #008631;
...
.card-body .btn-delete-decorators{
  color: white;
...
.card-body .btn-delete-decorators:hover, .card-body .btn-delete-decorators:focus{
  color: #031273;
  background-color: white;
  border-radius: 5px;
  border: 1px solid #031273;
    ...
    <body>
        <div class="admin-decorators" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Decorators List
                <a href="add_Decorations.php" class="btn-add-decorators-admin">
                    Add Decorators
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <label for="price" style="color: #ff1d8e;">
                                    Price (Planning Fee) : &nbsp
                                </label>
                                <label for="price" style="color: grey;">
                                <?php 
                                    echo $data['price'];
                                ?>
                                </label>
                                ...
                                <br>
                                <br>
                                <a href="edit_decorations.php?id=<?php echo $data['id']; ?>" class="btn-edit-decorators" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_decorations.php?id=<?php echo $data['id']; ?>" class="btn-delete-decorators" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
