...
.card-food-1 .btn-know:hover, .card-food-1 .btn-know:focus{
  color: #ff1d8e;
  background-color: white;
}

.card-food-1 .card-text{
  padding-bottom: 20px;
}
...
.card-food-2 .btn-know:hover, .card-food-2 .btn-know:focus{
  color: #ff1d8e;
  background-color: white;
}

.card-food-2 .card-text{
  padding-bottom: 20px;
}
        </style>
    </head>
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_food.php">
                    Food & Caterers
                </a>
            </div>
        </nav>
            ...
            <div class="col">
                <div class="card-food-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="food.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
