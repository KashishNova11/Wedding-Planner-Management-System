    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_bridal_wear.php">
                    Bridal Wear
                </a>
            </div>
        </nav>
            ...
            <div class="col">
                <div class="card-bridal-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="bridal_wear.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
