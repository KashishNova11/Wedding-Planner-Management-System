...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .card-music-1 .btn-know:hover, .card-music-1 .btn-know:focus{
            color: #ff1d8e;
            background-color: white;
            }

            .card-music-1 .card-text{
            padding-bottom: 20px;
            }
            ...
            .card-music-2 .btn-know:hover, .card-music-2 .btn-know:focus{
            color: #ff1d8e;
            background-color: white;
            }

            .card-music-2 .card-text{
            padding-bottom: 20px;
            }
        </style>
    </head>
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_music_dance.php">
                    Music & Dance Vendors
                </a>
            </div>
        </nav>
            ...
            <div class="col">
                <div class="card-music-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="music_dance.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
