    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_photographer.php">
                    Makeup & Hairstyles
                </a>
            </div>
        </nav>
            ...
            <div class="col">
                <div class="card-makeup-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="makeup_hair.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
