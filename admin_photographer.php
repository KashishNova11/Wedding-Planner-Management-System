...
<html lang="en">
    ...
    <body>
        <div class="admin-photographer" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Photographers List
                <a href="add_photographer.php" class="btn-add-photographer-admin">
                    Add Photographer
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <label for="photo_pkg" style="color: #ff1d8e;">
                                    Photo Package : &nbsp
                                </label>
                                <label for="photo_pkg" style="color: grey;">
                                <?php 
                                    echo $data['photo_pkg'];
                                ?>
                                </label>
                                <br>
                                <label for="photo_video_pkg" style="color: #ff1d8e;">
                                    Photo + Video Package : &nbsp
                                </label>
                                <label for="photo_video_pkg" style="color: grey;">
                                <?php 
