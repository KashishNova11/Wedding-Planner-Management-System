...
<html lang="en">
    ...
    <body>
        <div class="admin-hotels" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Wedding Hotel List
                <a href="add_hotels.php" class="btn-add-hotels-admin">
                    Add Hotel
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <br>
                                <a href="edit_hotels.php?id=<?php echo $data['id']; ?>" class="btn-edit-hotels" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_hotels.php?id=<?php echo $data['id']; ?>" class="btn-delete-hotels" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
