...
<html lang="en">
    <head>
        ...
        <title>
            Lawns / Farmhouses List
        </title>
        <link rel="shortcut icon" type="icon" href="img/wedmegood.png">
        <link rel="stylesheet" href="css/bootstrap.css">
    </head>
    <body>
        <div class="admin-lawns-farmhouses" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Lawns / Farmhouses List
                <a href="add_lawns_farmhouses.php" class="btn-add-lawns-admin">
                    Add Lawns / Farmhouses
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <br>
                                <a href="edit_lawns.php?id=<?php echo $data['id']; ?>" class="btn-edit-lawns" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_lawns.php?id=<?php echo $data['id']; ?>" class="btn-delete-lawns" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
