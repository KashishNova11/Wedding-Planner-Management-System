    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_mehndi.php">
                    Mehndi Aritst
                </a>
            </div>
        </nav>
            ...
            <div class="col">
                <div class="card-mehndi-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="mehndi.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
