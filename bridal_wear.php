...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .list-group-bridal .list-group-item .starting-prc{
            color: #ff1d8e;
            font-size: 25px;
            margin-left: 10px;
            padding-top: 7px;
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-bridal" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="booking.php" class="btn-booking-bridal" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
