...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .card-decorations-1 img{
            border-top-left-radius: 15px;
            border-top-right-radius: 15px;
            }

            .card-decorations-1 .btn-know{
            color: white;
            ...
            .card-decorations-1 .btn-know:hover, .card-decorations-1 .btn-know:focus{
            color: #ff1d8e;
            background-color: white;
            }

            .card-decorations-1 .card-text{
            padding-bottom: 20px;
            }
            ...
            .card-decorations-2 img{
            border-top-left-radius: 15px;
            border-top-right-radius: 15px;
            }

            .card-decorations-2 .btn-know{
            color: white;
            background-color: #ff1d8e;
            text-decoration: none;
            font-size: 17px;
            ...
            .card-decorations-2 .btn-know:hover, .card-decorations-2 .btn-know:focus{
            color: #ff1d8e;
            background-color: white;
            }

            .card-decorations-2 .card-text{
            padding-bottom: 20px;
            }
        </style>
    </head>
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_decorations.php">
                    Decorators
                </a>
            </div>
        </nav>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            ?>
            <div class="col">
                <div class="card-decorations-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="decorations.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
            ...
            ?>
            <div class="col">
                <div class="card-decorations-2 h-100">
                    <img src="<?php echo "img/".$data['img']; ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php
