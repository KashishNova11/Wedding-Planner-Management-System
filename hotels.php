...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .btn-booking-hotels:hover, .btn-booking-hotels:focus{
            color: white;
            background-color: #008631;
            }
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-hotels" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="hotels_booking.php" class="btn-booking-hotels" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
