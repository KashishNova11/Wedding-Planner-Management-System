<?php
    ...
    include "config.php";
    $query = "SELECT * FROM `banquet_halls`";
...
<html lang="en">
    ...
    <body>
        <div class="admin-banquet-halls" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Banquet Halls List
                <a href="add_banquet_halls.php" class="btn-add-banquet-admin">
                    Add Banquet Halls
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <label for="address" style="color: #ff1d8e;">
                                    Address : &nbsp
                                </label>
                                <label for="address" style="color: grey;">
                                <?php 
                                    echo $data['address'];
                                ?>
                                </label>
                                ...
                                <br>
                                <label for="indoor" style="color: #ff1d8e;">
                                    Indoor : &nbsp
                                </label>
                                <label for="indoor" style="color: grey;">
                                <?php 
                                    echo $data['indoor'];
                                ?>
                                </label>
                                <br>
                                <label for="outdoor" style="color: #ff1d8e;">
                                    Outdoor : &nbsp
                                </label>
                                <label for="outdoor" style="color: grey;">
                                <?php 
                                    echo $data['outdoor'];
                                ?>
                                </label>
                                <br>
                                <label for="in_out" style="color: #ff1d8e;">
                                    Indoor & Outdoor : &nbsp
                                </label>
                                <label for="in_out" style="color: grey;">
                                <?php 
                                    echo $data['in_out'];
                                ?>
                                </label>
                                ...
                                <br>
                                <br>
                                <a href="edit_banquet_halls.php?id=<?php echo $data['id']; ?>" class="btn-edit-banquet" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_banquet_halls.php?id=<?php echo $data['id']; ?>" class="btn-delete-banquet" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
