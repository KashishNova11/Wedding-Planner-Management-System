...
<html lang="en">
    ...
    <body>
        <div class="admin-groom" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Groom Wear Lisyt
                <a href="add_groom_wear.php" class="btn-add-groom-admin">
                    Add Groom Wear
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <label for="suit_tux" style="color: #ff1d8e;">
                                    Suit / Tux : &nbsp
                                </label>
                                <label for="suit_tux" style="color: grey;">
                                <?php 
                                    echo $data['suit_tux'];
                                ?>
                                </label>
                                <br>
                                <label for="sherwani_price" style="color: #ff1d8e;">
                                    Sherwani Price : &nbsp
                                </label>
                                <label for="sherwani_price" style="color: grey;">
                                <?php 
                                ...
                                <br>
                                <br>
                                <a href="edit_groom_wear.php?id=<?php echo $data['id']; ?>" class="btn-edit-photographer" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_groom_wear.php?id=<?php echo $data['id']; ?>" class="btn-delete-photographer" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
