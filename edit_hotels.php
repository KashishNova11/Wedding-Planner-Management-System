...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $query = "UPDATE `hotels` SET `name`='$name',`location`='$location',`address`='$address',`veg`='$veg',`non_veg`='$non_veg',`img`='$img',`indoor`='$indoor',`outdoor`='$outdoor',`in_out`='$in_out',`about`='$about' WHERE `id` = '$id_new'";
        ...
        {
            header("location:admin_hotels.php?update_msg=Data Updated Successfully...");
        }
    }
?>
...
<html lang="en">
    ...
    <body>
        <div class="form-container-hotels">
            <form action="edit_hotels.php?id_new=<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                <h3>
                    Update Hotels
                </h3>
                <label for="name">
                ...
                <input type="submit" name="submit" Value="Done" class="btn-update-hotels">
                <a href="admin_home.php" class="btn-back-hotels">
                    Back Home 
                </a>
            </form>
        </div>
