<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $insert = "INSERT INTO `lawns_farmhouses`(`name`,`location`,`address`,`veg`,`non_veg`,`img`,`indoor`,`outdoor`,`in_out`,`about`) VALUES('$name','$location','$address','$veg','$non_veg','$img','$indoor','$outdoor','$in_out','$about')";
        ...
        if($result)
        {
            ...
            header("location:add_lawns_farmhouses.php");
        }
    ...
    <body>
        <div class="form-container-lawns">
            <?php
                ...
                ?>
            <form action="add_lawns_farmhouses.php" method="post" enctype="multipart/form-data">
                <h3>
                    Add Lawns and Farmhouses
                </h3>
                <label for="name">
                    Name
                </label>
                ...
                <input type="submit" name="submit" Value="Add Venue" class="btn-add-lawns">
                <a href="admin_lawns_farmhouses.php" class="btn-all-lawns">
                    Show All Lawns / Farmhouses
                </a>&nbsp
