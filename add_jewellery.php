<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $insert = "INSERT INTO `jewellery`(`name`,`location`,`img`,`starting_price`,`about`) VALUES('$name','$location','$img','$starting_price','$about')";
    ...
    <body>
        <div class="form-container-jewellery">
            <?php
                ...
                ?>
            <form action="add_jewellery.php" method="post" enctype="multipart/form-data">
                <h3>
                    Add Jewellery
                </h3>
                <label for="name">
                ...
                <input type="submit" name="submit" Value="Add Vendor" class="btn-add-jewellery">
                <a href="admin_jewellery.php" class="btn-all-jewellery">
                    Show All Jewellery
                </a>&nbsp
