...
<html lang="en">
    <head>
        ...
        <title>
            Admin Music & Dance Vendors List
        </title>
        ...
        <style>
            ...
            .btn-add-music-admin:hover, .btn-add-music-admin:focus{
            color: white;
            background-color: grey;
            }
            

            .card-body .btn-edit-music{
            color: white;
            ...
            .card-body .btn-edit-music:hover, .card-body .btn-edit-music:focus{
            color: #008631;
            background-color: white;
            border-radius: 5px;
            border: 1px solid #008631;
            ...
            .card-body .btn-delete-music:hover, .card-body .btn-delete-music:focus{
            color: #031273;
            background-color: white;
            border-radius: 5px;
            border: 1px solid #031273;
    ...
    <body>
        <div class="admin-music" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Music & Dance Vendors List
                <a href="add_music_dance.php" class="btn-add-music-admin">
                    Add Music & Dance
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <label for="starting_price" style="color: #ff1d8e;">
                                    Starting Price : &nbsp
                                </label>
                                <label for="starting_price" style="color: grey;">
                                <?php 
                                    echo $data['starting_price'];
                                ?>
                                </label>
                                <br>
                                ...
                                <br>
                                <br>
                                <a href="edit_music_dance.php?id=<?php echo $data['id']; ?>" class="btn-edit-music" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_music_dance.php?id=<?php echo $data['id']; ?>" class="btn-delete-music" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
