...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .list-group-music .list-group-item .starting-prc{
            color: #ff1d8e;
            font-size: 20px;
            margin-left: 10px;
            padding-top: 7px;
            ...
            .list-group-music .list-group-item .starting{
            color: black;
            font-size: 18px;
            margin-left: 300px;
            }
            ...
            .btn-booking-music:hover, .btn-booking-music:focus{
            color: white;
            background-color: #008631;
            }
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-music" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="booking.php" class="btn-booking-music" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
