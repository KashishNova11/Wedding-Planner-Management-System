<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $insert = "INSERT INTO `banquet_halls`(`name`,`location`,`address`,`veg`,`non_veg`,`img`,`indoor`,`outdoor`,`in_out`,`about`) VALUES('$name','$location','$address','$veg','$non_veg','$img','$indoor','$outdoor','$in_out','$about')";
        ...
        if($result)
        {
            ...
            header("location:add_banquet_halls.php");
        }
    ...
    <body>
        <div class="form-container-banquet">
            <?php
                ...
                ?>
            <form action="add_banquet_halls.php" method="post" enctype="multipart/form-data">
                <h3>
                    Add Banquet Halls
                </h3>
                <label for="name">
                ...
                <input type="submit" name="submit" Value="Add Venue" class="btn-add-banquet">
                <a href="admin_banquet_halls.php" class="btn-all-banquet">
                    Show All Banquet Halls
                </a>&nbsp
