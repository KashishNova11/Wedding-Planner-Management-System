<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $insert = "INSERT INTO `b_hotels`(`bg`,`name`,`email`,`contact`,`v_name`,`from_this_date`,`to_this_date`,`from_this_time`,`to_this_time`,`space`,`function`) VALUES('$bg','$name','$email','$contact','$v_name','$from_this_date','$to_this_date','$from_this_time','$to_this_time','$space1','$function1')";
        ...
        {
            header("location:hotels_booking.php");
        }
    }
