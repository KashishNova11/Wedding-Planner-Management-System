<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $insert = "INSERT INTO `b_banquet_halls`(`bg`,`name`,`email`,`contact`,`v_name`,`from_this_date`,`to_this_date`,`from_this_time`,`to_this_time`,`space`,`function`) VALUES('$bg','$name','$email','$contact','$v_name','$from_this_date','$to_this_date','$from_this_time','$to_this_time','$space1','$function1')";
        ...
        {
            header("location:banquet_halls_booking.php");
        }
    }
    ...
    <body>
        ...
        <div class="form-container">
            <form action="" method="post">
                ...
                <input type="tel" id="contact" name="contact" value="<?php echo $data['contact']; ?>" required>
                <label for="v_name">
                    Venue Name
                </label>
