<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $insert = "INSERT INTO `resorts`(`name`,`location`,`address`,`veg`,`non_veg`,`img`,`indoor`,`outdoor`,`in_out`,`about`) VALUES('$name','$location','$address','$veg','$non_veg','$img','$indoor','$outdoor','$in_out','$about')";
    ...
    <body>
        <div class="form-container-resorts">
            <?php
                ...
                ?>
            <form action="add_resorts.php" method="post" enctype="multipart/form-data">
                <h3>
                    Add Wedding Resorts
                </h3>
                <label for="name">
                ...
                <input type="submit" name="submit" Value="Add Venue" class="btn-add-resorts">
                <a href="admin_resorts.php" class="btn-all-resorts">
                    Show All Resorts
                </a>&nbsp
