    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-banquet" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="lawns_farmhouses_booking.php" class="btn-booking-banquet" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="client_lawns_farmhouses.php">
                        Lawns / Farmhouses
                    </a>
                </li>
