...
<html lang="en">
    <head>
        ...
        <title>
            Admin Bridal Wear List
        </title>
        <link rel="shortcut icon" type="icon" href="img/wedmegood.png">
        <link rel="stylesheet" href="css/bootstrap.css">
    </head>
    <body>
        <div class="admin-bridal" style="padding-left:150px; background-color: #031273; color: white; padding-top: 10px; padding-bottom: 10px;">
            <h2>
                Bridal Wear List
                <a href="add_bridal_wear.php" class="btn-add-bridal-admin">
                    Add Bridal Wear
                </a>
                ...
                <div class="accordion-body" style="margin-top: 10px; margin-left: 10px;">
                        <div class="row g-0">
                            ...
                            <div class="card-body">
                                ...
                                <br>
                                <br>
                                <a href="edit_bridal_wear.php?id=<?php echo $data['id']; ?>" class="btn-edit-bridal" tabindex="-1" role="button" aria-disabled="true">
                                    Edit
                                </a>
                                <a href="delete_bridal_wear.php?id=<?php echo $data['id']; ?>" class="btn-delete-bridal" tabindex="-1" role="button" aria-disabled="true">
                                    Delete
                                </a>
                            </div>
                            </div>
