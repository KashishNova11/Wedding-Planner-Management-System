<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $insert = "INSERT INTO `decorations`(`name`,`location`,`img`,`price`,`about`) VALUES('$name','$location','$img','$price','$about')";
        ...
        if($result)
        {
            ...
            header("location:add_decorations.php");
        }
...
.form-container-decorators .btn-add-decorators{
  width: 150px;
...
.form-container-decorators .btn-add-decorators:hover{
  background-color: white;
  color: #ff1d8e;
  border: 1px solid #ff1d8e;
}

.form-container-decorators .btn-all-decorators{
  color: white;
...
.form-container-decorators .btn-all-decorators:hover, .form-container-decorators .btn-all-decorators:focus{
  color: #008631;
  background-color: white;
  border: 1px solid #008631; 
}

.form-container-decorators .btn-back-home{
  color: white;
  background-color: #031273;
  text-decoration: none;
  margin-left: -5px;
...
.form-container-decorators .btn-back-home:hover, .form-container-decorators .btn-back-home:focus{
  color: #031273;
  background-color: white;
  border: 1px solid #031273;
}
    ...
    <body>
        <div class="form-container-decorators">
            <?php
                ...
                ?>
            <form action="add_decorations.php" method="post" enctype="multipart/form-data">
                <h3>
                    Add Decorators
                </h3>
                <label for="name">
                ...
                <input type="submit" name="submit" Value="Add Vendor" class="btn-add-decorators">
                <a href="admin_decorations.php" class="btn-all-decorators">
                    Show All Decorators
                </a>&nbsp
