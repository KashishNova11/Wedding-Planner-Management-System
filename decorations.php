...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .list-group-decorators .list-group-item .price{
            color: #ff1d8e;
            font-size: 20px;
            margin-left: 10px;
            padding-top: 7px;
            ...
            .list-group-decorators .list-group-item .prc{
            color: black;
            font-size: 18px;
            margin-left: 220px;
            }
            ...
            .navbar-brand-decorators:hover{
                color: white;
            }

            .btn-booking-decorators{
            color: #ff1d8e;
            background-color: white;
            text-decoration: none;
            font-size: 18px;
            ...
            .btn-booking-decorators:hover, .btn-booking-decorators:focus{
            color: white;
            background-color: #008631;
            }
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-decorators" href="">
                    <?php
                        echo $data['name'];
                    ?>
                </a>
                <a href="booking.php" class="btn-booking-decorators" tabindex="-1" role="button" aria-disabled="true">
                    Booking
                </a>
            </div>
        </nav>
        ...
        <ul class="list-group-decorators">
