    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_lawns_farmhouses.php">
                Lawns / Farmhouses
                </a>
            </div>
        </nav>
            ...
            <div class="col">
                <div class="card-lawns-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="lawns_farmhouses.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
