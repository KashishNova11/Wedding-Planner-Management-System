    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand-client" href="client_banquet_halls.php">
                    Banquet Halls
                </a>
            </div>
        </nav>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            ?>
            <div class="col">
                <div class="card-banquet-1 h-100">
                    ...
                    <div class="card-body">
                        ...
                        <a href="banquet_halls.php?id=<?php echo $data['id'] ?>" class="btn-know">
                            Know More
                        </a>
                    </div>
                </div>
            ...
            ?>
            <div class="col">
                <div class="card-banquet-2 h-100">
                    <img src="<?php echo "img/".$data['img']; ?>" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php
